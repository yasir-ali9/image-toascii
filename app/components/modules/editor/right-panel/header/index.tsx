  ...
  return (
    <div className="flex h-[37px] shrink-0 items-center justify-between border-b border-bd-50 bg-bk-40 px-2">
      <button
        ...
        className="flex h-6 w-6 cursor-pointer items-center justify-center rounded text-fg-50 hover:bg-bk-30 hover:text-fg-30"
      ...
      <button
        ...
        className="flex h-6 w-6 cursor-pointer items-center justify-center rounded text-[13px] font-medium text-fg-50 hover:bg-bk-30 hover:text-fg-30"
        onClick={toggleTheme}
        type="button"
      >
        ◩
